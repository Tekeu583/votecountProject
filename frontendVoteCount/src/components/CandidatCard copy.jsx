    ...
    return (
        ...
        >
            ...
            <div className="relative">
                ...
                {/* Rank en haut à gauche — uniquement si résultats en temps réel activés */}
                {showResults && candidate.rank > 0 && candidate.rank <= 3 && (
                    <div className="absolute top-4 left-4  bg-white/95 backdrop-blur-sm px-3.5 py-1 rounded-2xl text-sm font-bold flex items-center gap-1.5 shadow">
            ...
            <div className="p-4">
                ...
                {candidate.party && (
                    <p className="text-blue-600 font-medium mt-1">{candidate.party}</p>
                )}
                {candidate.slogan && (
